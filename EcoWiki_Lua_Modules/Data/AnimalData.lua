    ...
    animals = {
        ['Agouti'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "小さな茶色がかった齧歯類で、鋭い切歯を持ち、硬い種子や果実を割るのを助け、種子の散布に重要な役割を果たします。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Alligator'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "大きな鱗状の爬虫類で、強力な噛みつきと長い尾を持ち、暖かい地域の川や沼地、湖の近くでよく見られます。ワニは、何百万年もの間ほとんど変わっていなかった古代の生き物です。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'True',
                    ['IsFishable'] = 'False',
                    ...
                    ['ResourceMax'] = '1',
                    ['ResourceBonusAtGrowth'] = '0.9',
                    ['TimeTill50PercentCloserToMaxInHours'] = '12',
                    ['MaxGrowthRatePerHour'] = '12',
                    ['TimeToSpread1ToNeighborInHours'] = '12',
                    ['ReleasesCO2TonsPerDay'] = '0.02',
        },
        ['Bass'] = {
        ...
        ['Bighorn Sheep'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['German'] = "Diese wilden Huftiere sind bekannt für ihre charakteristischen, gebogenen Hörner, die sie bei Dominanzkämpfen und zur Balz in der Paarungszeit einsetzen. Sie sind gut an raue Umgebungen angepasst und kommen sowohl in Berg- als auch in Wüstenregionen vor.",
                            ...
                            ['Japanese'] = "これらの野生の有蹄類は特徴的な湾曲した角で知られており、優位争いや交尾期の披露に使われます。過酷な環境に適応しており、山岳地帯と砂漠地帯の両方に生息しています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Bison'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "巨大で毛深い哺乳類で、大きな頭、こぶのある肩、特徴的な湾曲した角を持っています。草原や草原でよく草を食んでいるバイソンは、保全活動により絶滅寸前から驚くべき復活を遂げた重要な例です。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Coyote'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "賢く適応力のあるイヌ科動物で、ふさふさした尾と特徴的な遠吠えや鳴き声を持っています。コヨーテは、その略歴や狩猟能力で知られており、さまざまな生息地で見られます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Crab'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "硬い外骨格を持ち、防御、採餌、求愛ディスプレイに使われる大きなハサミ2本を持つ甲殻類です。カニは雑食性で、藻類や他の無脊椎動物、死肉など様々な食物を食べます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'True',
                    ['IsFishable'] = 'False',
        ...
        ['Deer'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "赤褐色の毛皮を持つ優雅な草食哺乳類で、森や野原に生息しています。シカは捕食者を避けるために、優れた聴覚、嗅覚、視覚、そして速く走り、高くジャンプする能力など、さまざまな適応を進化させてきました。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Elk'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "森林や草原に生息する威厳あるシカの種で、大きな角と茶灰色の被毛が特徴です。雄エルク(雄)は毎年成長し、最大1.2メートル(4フィート)に達する角を脱ぎ捨てます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Fox'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "小さくて敏捷なイヌ科動物で、赤橙色の毛皮とふさふさした尾を持っています。キツネは知性と問題解決能力で知られており、野外では道具を使い、高度な問題解決能力を示す姿が観察されています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Hare'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "長く優れた耳と力強い後肢が特徴の速く敏捷な哺乳類です。ウサギは一般的にウサギよりも大きく速く、より孤独な生活を送っています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Jaguar'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "特徴的な黒い斑点と筋肉質な体格を持つ大型の野生の猫で、しばしば密林で見られます。ジャガーは頂点捕食者であり、天敵はいませんが、生息地の喪失や密猟によって脅かされることがあります。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Mountain Goat'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "白くもじゃくした毛皮と湾曲した角を持つ野生のヤギの一種で、急峻で岩だらけの地形に適応しています。彼らの分かれた蹄は優れた牽引力を提供し、白い毛皮は雪に覆われた環境に溶け込むのに役立ちます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Otter'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "遊び好きで敏捷な半水生哺乳類で、よく仰向けに浮かんだり水中の物で遊んだりします。カワウソは厚く防水の毛皮を持ち、冷たい水でも暖かく保ち、水かきのある足で泳ぐのに優れています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'True',
                    ['IsFishable'] = 'False',
        ...
        ['Prairie Dog'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "広大な地下の巣穴に住み、複数の入口やトンネルを持つ非常に社交的なげっ歯類です。彼らは特徴的な吠え声のような鳴き声を使ってコロニーの他の仲間とコミュニケーションを取り、潜在的な捕食者を知らせることも含まれます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Snapping Turtle'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "特徴的な鉤状のくちばしと強力な顎を持つ淡水カメで、攻撃的な行動と幅広い水生環境に適応できる能力で知られています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Tortoise'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "硬くドーム状の甲羅を持つ陸生のゆっくりとした爬虫類で、捕食者からの防御を提供します。リクガメは草食性で寿命が長く、中には150年以上生きる個体もいます。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Turkey'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "特徴的な羽毛と首に肉質の肉質の肉垂があり、気分によって色を変えることができる大型の鳥です。七面鳥は非常に社交的で、有名なゴブル(ゴブル)を含む印象的な鳴き声で知られています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
        ...
        ['Wolf'] = {
                    ...
                    ['Description'] =  {
                            ...
                            ['Japanese'] = "特徴的な遠吠えをする大型の肉食性イヌ科動物で、世界中のさまざまな生息地に生息しています。多くの生態系で重要な種であり、社会的な行動と協力的な狩猟戦略で知られています。",
                            },
                    ['MaturityAgeDays'] = '1',
                    ['IsSwimming'] = 'False',
                    ['IsFishable'] = 'False',
